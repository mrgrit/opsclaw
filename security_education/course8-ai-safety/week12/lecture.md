...
EU AI Act(위험 기반 분류), NIST AI RMF(Govern/Map/Measure/Manage), 한국 AI 기본법, 공정성/투명성/책임성/프라이버시
...
curl -s http://192.168.0.105:11434/v1/chat/completions \
  ...
  -d '{
    ...
    "messages": [
      ...
      {"role": "user", "content": "이번 주차 주제에 대해 설명해줘: AI 윤리와 규제"}
    ],
    "max_tokens": 200
  }'
```
