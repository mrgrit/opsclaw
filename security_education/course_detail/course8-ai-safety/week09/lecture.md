# Week 09: 모델 보안 - 모델 도난과 추론 공격 (상세 버전)
...
**Q1.** "Week 09: 모델 보안 - 모델 도난과 추론 공격"에서 가장 핵심적인 학습 목표는?
- (a) 데이터베이스 최적화  (b) **AI Safety의 원리와 실습**  (c) UI 개발  (d) 네트워크 속도

**Q2.** "1. 모델 보안 위협 개요"의 보안 관점에서의 의의는?
- (a) 성능 향상  (b) **보안 위협 이해 또는 방어 역량 강화**  (c) 비용 절감  (d) 사용성 개선

**Q3.** "2. 모델 추출 공격"에서 사용하는 주요 도구/기법은?
