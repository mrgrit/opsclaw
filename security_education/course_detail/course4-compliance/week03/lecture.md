...
**Q1.** "Week 03: ISO 27001 (2) - 통제 항목 (A.5~A.8)"에서 가장 핵심적인 학습 목표는?
- (a) 데이터베이스 최적화  (b) **보안 표준/컴플라이언스의 원리와 실습**  (c) UI 개발  (d) 네트워크 속도

**Q2.** "1. Annex A 통제 항목 개요"의 보안 관점에서의 의의는?
- (a) 성능 향상  (b) **보안 위협 이해 또는 방어 역량 강화**  (c) 비용 절감  (d) 사용성 개선

**Q3.** "2. A.5 조직적 통제 (37개)"에서 사용하는 주요 도구/기법은?
