...
**Q1.** "Week 04: ISO 27001 (3) - 기술 통제 실습"에서 가장 핵심적인 학습 목표는?
- (a) 데이터베이스 최적화  (b) **보안 표준/컴플라이언스의 원리와 실습**  (c) UI 개발  (d) 네트워크 속도

**Q2.** "1. 실습 환경 구성 확인"의 보안 관점에서의 의의는?
- (a) 성능 향상  (b) **보안 위협 이해 또는 방어 역량 강화**  (c) 비용 절감  (d) 사용성 개선

**Q3.** "2. A.8.1 사용자 단말 장치 (User Endpoint Devices)"에서 사용하는 주요 도구/기법은?
...
**Q5.** "3. A.8.2 특수 접근 권한 (Privileged Access Rights)"의 실무 활용 방안은?
