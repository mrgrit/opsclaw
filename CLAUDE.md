...
| 서버 | 내부 IP | 외부 IP | 역할 | SubAgent |
|------|---------|---------|------|----------|
| opsclaw | 10.20.30.201 | 192.168.0.107 | control plane | http://localhost:8002 |
| secu | 10.20.30.1 | 192.168.208.150 | nftables + Suricata IPS | http://10.20.30.1:8002 |
| web | 10.20.30.80 | 192.168.208.151 | BunkerWeb WAF + JuiceShop | http://10.20.30.80:8002 |
| siem | 10.20.30.100 | 192.168.208.152 | Wazuh 4.11.2 | http://10.20.30.100:8002 |
| dgx-spark | - | 192.168.0.105 | GPU compute + Ollama LLM | http://192.168.0.105:8002 |

> **IP/포트는 Central Config에서 관리**: `http://localhost:7000/app/config`
...
| Central Server | http://localhost:7000 | 통합 관리 (Config/인스턴스/블록체인/CTF) |
| Bastion API | http://localhost:9000 | 실무 운영/보안 에이전트 |
| CCC API | http://localhost:9100 | 교육 플랫폼 |
