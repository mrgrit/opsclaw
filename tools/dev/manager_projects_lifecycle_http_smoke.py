...
def main() -> int:
    ...
    create_response = client.post(
        "/projects",
        json={
            "name": "lifecycle-http-project",
            "request_text": "lifecycle http smoke",
            "mode": "one_shot",
        },
    )
    ...
    print("HTTP_PLAN_STAGE:", planned["project"]["current_stage"])
    print("HTTP_EXECUTE_STAGE:", executed["result"]["project"]["current_stage"])
    print("HTTP_VALIDATE_STAGE:", validated["result"]["project"]["current_stage"])
